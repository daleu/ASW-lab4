...
try{
	...
	echo PHP_EOL, PHP_EOL, "----------- HTTP REQUEST :", PHP_EOL;
	echo $sClient->__getLastRequestHeaders(),PHP_EOL;
	echo xmlpp($sClient->__getLastRequest()),PHP_EOL;
	echo PHP_EOL, PHP_EOL,"----------- HTPP RESPONSE :",PHP_EOL;
